...
export default defineType({
  ...
  type: "object",
  title: "Legal Section",
  description: "A section header with a tag line, title, and markdown-formatted description for legal content",
  icon: Scale,
  fields: [
    defineField({
      name: "padding",
    ...
    defineField({
      ...
      type: "block-content",
      title: "Description",
      description: "Rich text content with markdown formatting support",
    }),
    defineField({
      name: "links",
      type: "array",
