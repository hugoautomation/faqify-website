...
export type Feature3Card = {
  ...
  iconVariant?: "none" | "code" | "git-branch" | "list" | "play" | "sparkles" | "wand-sparkles";
  title?: string;
  description?: string;
  image?: {
    asset?: {
...
export type PAGE_QUERYResult = {
  blocks: Array<{
    ...
    columns: Array<{
      _type: "feature-3-card";
      _key: string;
      iconVariant: "code" | "git-branch" | "list" | "none" | "play" | "sparkles" | "wand-sparkles" | null;
      title: string | null;
      description: string | null;
      image: {
        asset: {
