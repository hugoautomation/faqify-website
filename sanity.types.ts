...
// Query: *[_type == "contact"][0]{  tagline,  title,  description,  contactMethods[]{    icon,    title,    description,        _key,    ...,    "href": select(      isExternal => href,      @.internalLink->slug.current    )  },  meta_title,  meta_description,  noindex,  ogImage {    asset->{      _id,      url,      metadata {        dimensions {          width,          height        }      }    },  }}
export type CONTACT_QUERYResult = {
  tagline: string | null;
  title: string | null;
  description: string | null;
  contactMethods: Array<{
    icon?: "mail" | "mapPin" | "messages" | "phone";
    title?: string;
    description?: string;
    _key: string;
    link?: Link;
